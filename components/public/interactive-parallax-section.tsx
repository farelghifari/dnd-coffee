    ...
    <section className="relative w-full h-[700px] md:h-[950px] bg-[#1C1C1E] overflow-hidden flex flex-col items-center justify-center border-y-8 border-[#D4A24A] font-sans">
      ...
      <div className="relative z-20 text-center pointer-events-none px-6 pt-16 md:pt-24 max-w-5xl mb-auto">
        <motion.h2 
          ...
          className="text-6xl md:text-8xl lg:text-[9rem] font-black text-[#BFC0C2] tracking-tighter mb-4 leading-[0.8]" 
      ...
      >
        <div className="p-8 bg-[#1C1C1E]/5 backdrop-blur-xl rounded-[2rem] border-2 border-[#1C1C1E]/10 rotate-[-15deg] shadow-2xl">
      ...
      >
        <div className="p-10 bg-[#D4A24A]/10 backdrop-blur-2xl rounded-full border-2 border-[#D4A24A]/30 rotate-[25deg] shadow-2xl">
