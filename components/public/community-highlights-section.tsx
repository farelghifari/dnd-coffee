      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col xl:flex-row items-center gap-16">
        ...
        <div className="flex-1 w-full relative z-20">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full border border-[#D4A24A] text-[#D4A24A] font-bold text-xs tracking-[0.3em] uppercase mb-8 bg-[#2D2D30]">
              <Users size={16} />
            ...
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 leading-[1.1]">
              The Creators' <br/>
              <span className="text-[#D4A24A]" style={{ fontFamily: "'Bryndan Write', 'Kalam', cursive" }}>Canvas.</span>
            </h2>
            
            <p className="text-xl md:text-2xl leading-relaxed text-[#BFC0C2] font-light mb-6 max-w-xl">
            ...
            <p className="text-lg leading-relaxed text-[#7A7A7D] font-medium mb-12 max-w-xl italic border-l-4 border-[#D4A24A] pl-6">
            ...
            <ul className="flex flex-col gap-6 text-lg font-medium opacity-90">
              <li className="flex items-center gap-4">
                <div className="p-3 bg-[#D4A24A]/20 rounded-full text-[#D4A24A]">
                  <MonitorPlay size={24} />
                </div>
